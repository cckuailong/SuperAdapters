...
from core.seq2seq.mistrial import MistrialSeq2Seq
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', default="llama", choices=['llama', 'llama2', 'chatglm', 'chatglm2', 'bloom', 'qwen', "baichuan", "mistrial", "phi"])
    ...
    if args.task_type == "seq2seq":
        if args.model_type == "chatglm" or args.model_type == "chatglm2":
            ...
            llm = BaichuanSeq2Seq()
        elif args.model_type == "mistrial":
            llm = MistrialSeq2Seq()
        elif args.model_type == "phi":
            llm = PhiSeq2Seq()
        else:
            print("model_type should be llama/llama2/bloom/chatglm/chatglm2/qwen/baichuan/mistrial/phi")
            sys.exit(-1)
        ...
        if args.model_type == "chatglm" or args.model_type == "chatglm2":
            ...
            print("Classify with Mistrial is not support now.")
            sys.exit(-1)
        elif args.model_type == "phi":
